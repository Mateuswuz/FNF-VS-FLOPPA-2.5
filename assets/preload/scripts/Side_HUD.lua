...
function onCreate()
    ...
    makeLuaText("sick", 'Flops!: 0', 200, getProperty('cm.x'), getProperty('cm.y') + 30);
    makeLuaText("good", 'Cools: 0', 200, getProperty('cm.x'), getProperty('sick.y') + 30);
    makeLuaText("bad", 'Bads :<: 0', 200, getProperty('cm.x'), getProperty('good.y') + 30);
    makeLuaText("shit", 'Stupids: 0', 200, getProperty('cm.x'), getProperty('bad.y') + 30);
    makeLuaText("miss", 'Bad vibes: 0', 200, getProperty('cm.x'), getProperty('shit.y') + 30);
...
function onUpdate(elapsed)
    ...
    setTextString('sick', 'Flops!: ' .. getProperty('sicks'))
    setTextString('good', 'Cools: ' .. getProperty('goods'))
    setTextString('bad', 'Bads :<: ' .. getProperty('bads'))
    setTextString('shit', 'Stupids: ' .. getProperty('shits'))
    setTextString('miss', 'Bad vibes: ' .. getProperty('songMisses'))
