    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Funkin-rent', 300, -305-IntroTagWidth, 210)
        ...
        makeLuaText('JukeBoxSubText2', 'By Zee', 200, -305-IntroTagWidth, 250)
        ...
        makeLuaText('JukeBoxSubText3', '(Charted by Salad & bob)', 400, -305-IntroTagWidth, 275)
